...
# install v2ray
wget https://raw.githubusercontent.com/rockneters/maladeva/main/V2RAY/go.sh && chmod +x go.sh && ./go.sh
rm -f /root/go.sh
bash -c "$(wget -O- https://raw.githubusercontent.com/rockneters/maladeva/main/V2RAY/trojan-quickstart.sh)"
mkdir /root/.acme.sh
curl https://raw.githubusercontent.com/rockneters/maladeva/main/V2RAY/acme.sh -o /root/.acme.sh/acme.sh
