...
wget -O /etc/accel-ppp.conf "https://raw.githubusercontent.com/rockneters/maladeva/main/OTHER/accel.conf"
...
#input perintah sstp
cd /usr/bin
wget -O add-sstp https://raw.githubusercontent.com/rockneters/maladeva/main/add-sstp.sh && chmod +x add-sstp
wget -O del-sstp https://raw.githubusercontent.com/rockneters/maladeva/main/del-sstp.sh && chmod +x del-sstp
wget -O cek-sstp https://raw.githubusercontent.com/rockneters/maladeva/main/cek-sstp.sh && chmod +x cek-sstp
wget -O renew-sstp https://raw.githubusercontent.com/rockneters/maladeva/main/renew-sstp.sh && chmod +x renew-sstp
cd
rm -f /root/sstp.sh
