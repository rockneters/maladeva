...
cd /usr/bin
wget -O add-l2tp https://raw.githubusercontent.com/rockneters/maladeva/main/OTHER/add-l2tp.sh && chmod +x add-l2tp
wget -O del-l2tp https://raw.githubusercontent.com/rockneters/maladeva/main/OTHER/del-l2tp.sh && chmod +x del-l2tp
wget -O add-pptp https://raw.githubusercontent.com/rockneters/maladeva/main/OTHER/add-pptp.sh && chmod +x add-pptp
wget -O del-pptp https://raw.githubusercontent.com/rockneters/maladeva/main/OTHER/del-pptp.sh && chmod +x del-pptp
wget -O renew-pptp https://raw.githubusercontent.com/rockneters/maladeva/main/OTHER/renew-pptp.sh && chmod +x renew-pptp
wget -O renew-l2tp https://raw.githubusercontent.com/rockneters/maladeva/main/OTHER/renew-l2tp.sh && chmod +x renew-l2tp
cd
